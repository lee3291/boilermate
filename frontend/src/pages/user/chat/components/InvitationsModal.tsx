                    ...
                    {isLoading ? (
                        ...
                        <div className="space-y-3">
                            {invitations.map((invitation) => {
                                const chat = invitation.chat;
                                if (!chat) {
                                    return (
                                        <div
                                            key={invitation.id}
                                            className="border border-gray-200 rounded-lg p-4 text-gray-500"
                                        >
                                            Invalid chat data
                                        </div>
                                    );
                                    ...
                                    >
                                        <div className="flex items-start gap-3">
                                            <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-white font-medium flex-shrink-0">
                                                {isGroupChat ? <Users size={20} /> : avatarContent}
                                            </div>

                                            {/* Display conversation/chat name */}
