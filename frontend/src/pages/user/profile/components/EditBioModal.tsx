      ...
      <div className='mx-4 w-full max-w-2xl rounded-2xl bg-white shadow-2xl'>
        ...
        <div className='p-8'>
          <div className='mb-4'>
            ...
            <input
              className='w-full rounded-lg border border-gray-300 p-2 placeholder:text-gray-400 focus:ring-2 focus:ring-pink-400 focus:outline-none'
              value={name}
          ...
          <div className='mb-4'>
            ...
            <textarea
              className='min-h-[80px] w-full rounded-lg border border-gray-300 p-2 placeholder:text-gray-400 focus:ring-2 focus:ring-pink-400 focus:outline-none'
              value={bio}
